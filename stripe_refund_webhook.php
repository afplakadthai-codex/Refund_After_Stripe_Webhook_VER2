...
function bvsw_is_already_succeeded(int $refundId, string $providerRefundId): bool
{
    if ($refundId <= 0 || !bvsw_table_exists('order_refund_transactions')) {
        return false;
    }

    $params = ['rid' => $refundId, 'status' => 'succeeded'];
